...
const ProductCard = ({ myproducts, item, handleProductDelete }) => {
  ...
  const handleProductCart = (_id, name, brand, price, image, email) => {
    ...
    fetch("https://giga-gadgets-server-six.vercel.app/carts", {
      method: "POST",
          ...
          <div className="flex flex-col ">
            ...
            <div className="flex-auto justify-evenly">
              <div className="flex flex-wrap ">
                ...
                {/* product name */}
                <div className="flex items-center w-full justify-between min-w-0 mt-4 ">
                  <h2 className="text-lg mr-auto cursor-pointer text-gray-800 hover:text-[#FF497C] truncate font-semibold dark:text-white">
                    {name}
                  </h2>
